...
pros::Motor left_front_middle(5,pros::motor_gearset_e::E_MOTOR_GEAR_BLUE, true);
pros::Motor left_back_middle(3,pros::motor_gearset_e::E_MOTOR_GEAR_BLUE, false);
pros::Motor left_back(4,pros::motor_gearset_e::E_MOTOR_GEAR_BLUE, true);
