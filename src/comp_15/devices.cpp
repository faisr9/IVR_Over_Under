...
// V5 Sensors //
pros::ADIEncoder vertical_track(5, 6, false); // tracking wheel #1 bc. Reversed values might be wrong
pros::ADIEncoder horizontal_track(3, 4, true); // tracking wheel #2 de
pros::Imu imu(21);
