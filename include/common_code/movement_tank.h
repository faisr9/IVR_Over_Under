...
void turnToAngle(traditional_drive& drive, double desiredAngleDeg, double toleranceDeg, bool debug = false, double p = 2.2, int time_in_range_millis = 150);
// Calculate the angle needed to face the goal when at a given (future) position.
void turnToPoint(traditional_drive& drive, double turnP = 2.2, double goalXCoordinate = 0.0, double goalYCoordinate = 0.0);
