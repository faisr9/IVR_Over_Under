...
void turnPID(traditional_drive& drive, double desiredAngleDeg, double toleranceDeg=.4, double p=.908, double i=0.000001, double d=1.15, int maxTime=2000);
void latPID(traditional_drive& drive, double target, double tolerance, double p=0.1, double i=0, double d=0, int maxTime=2500);
void movePID(traditional_drive& drive, double target, double angle, double latTolerance=1.2, double turnTolerance=.2, double lP=3.75, double lI=0.0, double lD=2,double tP=.908, double tI=0.000001, double tD=1.15, int maxTime=4000);
